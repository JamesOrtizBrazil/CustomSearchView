...
import com.example.customsearchview.RevealViewGroup;
import com.example.customsearchview.io.codetail.animation.SupportAnimator;
import com.example.customsearchview.io.codetail.animation.ViewAnimationUtils;
...
public class CustomSearchView
    ...
    private void setValuesToViews() {
        ...
        this.mSearchEditText.setFilters(new InputFilter[]{new InputFilter.AllCaps()});
        this.mSearchEditText.setInputType(InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS);
    ...
    private void setUpListeners() {
       /* mHomeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(TAG_LOG, "searchView mHomeButton.setOnClickListener " + mCurrentState.toString());
    ...
    private void showMicButton() {
        ...
        mMicButton.setImageDrawable(
                ResourcesCompat.getDrawable(getResources(), R.drawable.ic_microphone, null));
    }
    ...
    public void setHomeButtonClickListener(OnClickListener homeButtonClickListener) {
        this.mHomeButton.setOnClickListener(homeButtonClickListener);
    }
    ...
    public void openSearchHint(String query) {
    ...
    static class SavedState extends BaseSavedState {
        ...
        SearchViewState getCurrentSearchViewState() {
