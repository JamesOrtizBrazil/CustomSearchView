...
public class DefaultVoiceRecognizerDelegate
        extends VoiceRecognitionDelegate {
    ...
    public DefaultVoiceRecognizerDelegate(androidx.fragment.app.Fragment supportFragment) {
        super(supportFragment);
    }

    public DefaultVoiceRecognizerDelegate(androidx.fragment.app.Fragment supportFragment, int activityRequestCode) {
